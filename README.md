...
一个基于大模型的智能代理（Agent），具备**自主规划与执行**能力。通过对话交互，Agent 能够自动操控 Android 手机、浏览网页、搜索信息，并执行复杂的多步骤任务。

### 演示视频

- [游戏奖励领取](https://www.douyin.com/jingxuan?modal_id=7610351871508712738)
